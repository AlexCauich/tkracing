    ...
    <div class="container mt-4">
        <div class="jumbotron">
            <div class="row" id="App">
                ...
                <div class="col-md-4">
                    <form id="form-card" class="card">
                        <div class="card-header"><h6>Registrar Admin</h6></div>
                        <div class="card-body">
                            <input type="hidden" id="datoID">
                            <div class="form-group">
                                <label for="">Nombre de usuario</label>
                                <input type="text" name="username" id="username" class="form-control" placeholder="example@examp.com" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="r_pass" name="r_pass" class="form-control" placeholder="******" required>
                            </div>
                        </div>
